...
set.seed(36) # Answer to the Ultimate Question of Life, the Universe, and Everything
...
We perform a logistic regression using \item \textbf{stroke} as the dependent variable and the rest of the data as independent variables in order to see if we find some significant relationships.
...
#lr_preds_test <- c(0,0,0,0,0,0,0,0,0)
#i<-1
# for (thresh in seq(0.25,0.35,0.05)){
...
#  i<-i+1
# }
# names(lr_preds_test) <- seq(0.25,0.35,0.05)
#   
# 
# lr_preds_test
# lr_pred <- as.numeric(ifelse(lr_prob1 > 0.3,"1","0"))
